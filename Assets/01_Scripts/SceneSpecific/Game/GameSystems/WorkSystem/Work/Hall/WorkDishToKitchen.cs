...
public class WorkDishToKitchen : InteractWorkBase
{
    ...
    public WorkDishToKitchen(WorkManager workManager, WorkType workType, float interactTime = 1, bool isInteruptible = true, bool isStoppable = true) : base(workManager, workType, interactTime, isInteruptible, isStoppable)
    {
    }
